...
Each textbook has two prices: one price for the UCLA bookstore (`ucla_new`) and one price for Amazon. There is a natural correspondance between these prices, since they're for the same book! So we'll pair the data. 
